...
|link:https://github.com/itu-devops/BSc_lecture_notes/blob/master/sessions/session_10/README_EXERCISE.md[Scaling with load balancers and high-availabiltiy setup]
|link:https://github.com/itu-devops/BSc_lecture_notes/blob/master/sessions/session_10/README_TASKS.md[Refactor to high-availabiltiy setup]
// w16
|11
|14/4
|8:00 - 12:00
|
|link:https://github.com/itu-devops/BSc_lecture_notes/blob/master/sessions/session_11/IaC.pdf[Docker Swarm and Infrastructure as Code Revisited]
